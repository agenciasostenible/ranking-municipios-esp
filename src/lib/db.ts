...
export const SUBTITLES: Record<string, string> = {
  ...
  gastronomia:       'dónde comer: estrellas, soletes y sitios recomendados',
  ...
  senderismo:        'rutas señalizadas para caminar: GR, PR y sendas',
  ...
  naturaleza:        'parques, gargantas y parajes: qué ver',
  ...
  ciclismo:          'vías verdes y rutas en bici',
